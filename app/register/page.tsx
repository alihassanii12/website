          ...
          <div className="space-y-4">
            ...
            {formData.password && (
              <div className="space-y-2 text-xs">
                <p className={`flex items-center space-x-1 ${passwordStrength.length ? 'text-green-600' : 'text-gray-500'}`}>
                  <span>{passwordStrength.length ? '✓' : '○'}</span>
                  <span>At least 6 characters</span>
                </p>
                <p className={`flex items-center space-x-1 ${passwordStrength.uppercase ? 'text-green-600' : 'text-gray-500'}`}>
                  <span>{passwordStrength.uppercase ? '✓' : '○'}</span>
                  <span>At least one uppercase letter</span>
                </p>
                <p className={`flex items-center space-x-1 ${passwordStrength.lowercase ? 'text-green-600' : 'text-gray-500'}`}>
                  <span>{passwordStrength.lowercase ? '✓' : '○'}</span>
                  <span>At least one lowercase letter</span>
                </p>
                <p className={`flex items-center space-x-1 ${passwordStrength.number ? 'text-green-600' : 'text-gray-500'}`}>
                  <span>{passwordStrength.number ? '✓' : '○'}</span>
                  <span>At least one number</span>
                </p>
                <p className={`flex items-center space-x-1 ${passwordStrength.special ? 'text-green-600' : 'text-gray-500'}`}>
